        ...
        <div class="panel panel-red">
            ...
            <a href="categories.php">
                ...
                <?php
                    ...
                    $query = "SELECT * from comments where comments_status ='unapproved' ";
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
            ...
            $element_text = ['Active Posts','Subscribers','Draft Posts' ,'categories','Pending Comments', 'users', 'comments'];
            $element_count = [$post_counts,$subscriber_counts, $post_draft_counts , $categories_counts,$comment_unapproved_counts, $user_counts,$comment_counts];
              for($i = 0;$i <7  ;$i++)
              {
